...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> postRequest(Long userId, NewtItemRequestDto newtItemRequestDto) {
        return post("", userId, newtItemRequestDto);
    }
